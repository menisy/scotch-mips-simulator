...
public class RegistersFile {
    ...
    public void setFirstOperandDestination(String register)
    {
    ...
    public void setSecondOperandDestination(String register)
    {
  ...
  /*  public void setALURegister(String register)
    {
        ...
        {
            System.out.println("Computing the address ");
        ...
        this.alu.setOp1(offset + registerData);
        }
        else
        {
    ...
    public void forward()
    {
        this.memory.setData(this.registers.get(this.ALU_MUXRegister));
    }
