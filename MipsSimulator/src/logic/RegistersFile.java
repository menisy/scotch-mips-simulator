...
public class RegistersFile {
    ...
    HashMap<String, Integer> registers = new LinkedHashMap<String, Integer>();
    ALU alu;
    ALU_MUX aluMUX;
    DataMemory memory;
  ...
  public void setRegisters(HashMap<String,Integer> regs){
      registers = regs;
  }
    /**
    ...
    /**
     * The Method initializes the registers.
     */
